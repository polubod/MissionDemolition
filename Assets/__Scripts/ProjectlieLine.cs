...
public class ProjectlieLine : MonoBehaviour
{
    static List <ProjectlieLine> PROJ_LINES = new List<ProjectlieLine>();
    ...
    static void ADD_LINE( ProjectlieLine newLine){
        Color col;
        //Iterate over all the old lines and dim them
        foreach ( ProjectlieLine pl in PROJ_LINES ){
